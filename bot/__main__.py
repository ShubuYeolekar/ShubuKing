...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Owner", "https://t.me/ShubuYeole")
    buttons.buildbutton("Group Link", "https://t.me/+grJ8F4IrC8E1NTBl")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Bot made to mirror all your torrent to Google Drive!
